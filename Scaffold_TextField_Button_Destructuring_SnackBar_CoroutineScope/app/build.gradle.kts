...
android {
    namespace = "com.example.scaffold_textfield_button_destructuring_snackbar_coroutinescope"
    compileSdk = 33

    defaultConfig {
        applicationId = "com.example.scaffold_textfield_button_destructuring_snackbar_coroutinescope"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
